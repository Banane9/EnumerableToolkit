...
namespace EnumerableToolkit.Builder
{
    ...
    public static class AsyncParametrizedBlockAddingExtensions
    {
        ...
        {
            builder.AddBuildingBlock(new AsyncConcatBlock<T>(sequence).ToParametrized<T, TParameters>());
        ...
        {
            builder.AddBuildingBlock(new AsyncInsertAfterEveryItemLambdaBlock<T>(predicate, sequence).ToParametrized<T, TParameters>());
        ...
        {
            builder.AddBuildingBlock(new AsyncInsertAfterFirstItemLambdaBlock<T>(predicate, sequence).ToParametrized<T, TParameters>());
        ...
        {
            builder.AddBuildingBlock(new AsyncInsertBeforeEveryItemLambdaBlock<T>(predicate, sequence).ToParametrized<T, TParameters>());
        ...
        {
            builder.AddBuildingBlock(new AsyncInsertBeforeFirstItemLambdaBlock<T>(predicate, sequence).ToParametrized<T, TParameters>());
        ...
        {
            builder.AddBuildingBlock(new AsyncWhereItemLambdaBlock<T>(predicate).ToParametrized<T, TParameters>());
