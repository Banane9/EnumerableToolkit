...
{
    /// <summary>
    /// Contains extension methods for the <see cref="EnumerableBuilder{T}"/>
    ...
    public static class BlockAddingExtensions
    {
        ...
        public static void Concat<T>(this EnumerableBuilder<T> builder, T firstItem, params T[] following)
        ...
        public static void Concat<T>(this EnumerableBuilder<T> builder, IEnumerable<T> sequence)
        ...
        public static void InsertAfterEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, T firstItem, params T[] following)
        ...
        public static void InsertAfterEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertAfterEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="predicate">A predicate determining whether the <paramref name="sequence"/> of items should be inserted after an item.</param>
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertAfterEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertAfterFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertAfterFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertAfterFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="predicate">A predicate determining whether the <paramref name="sequence"/> of items should be inserted after that item.</param>
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertAfterFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertBeforeEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertBeforeEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertBeforeEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="predicate">A predicate determining whether the <paramref name="sequence"/> of items should be inserted before an item.</param>
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertBeforeEveryItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertBeforeFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertBeforeFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate, IEnumerable<T> sequence)
        ...
        /// <param name="firstItem">The first item to add.</param>
        /// <param name="following">Any other items to add.</param>
        public static void InsertBeforeFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, T firstItem, params T[] following)
        ...
        /// <param name="predicate">A predicate determining whether the <paramref name="sequence"/> of items should be inserted before that item.</param>
        /// <param name="sequence">A sequence of items that should be added.</param>
        public static void InsertBeforeFirstItem<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate, IEnumerable<T> sequence)
        ...
        public static void Where<T>(this EnumerableBuilder<T> builder, Func<T, int, bool> predicate)
        ...
        /// <param name="builder">The enumerable builder to add the building block to.</param>
        /// <param name="predicate">A predicate determining whether the current item should be returned.</param>
        public static void Where<T>(this EnumerableBuilder<T> builder, Func<T, bool> predicate)
